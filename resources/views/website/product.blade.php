...
<div class="container">
    ...
    <div class="container" >
        ...
        <div style=" background-color: #faf7f7 ;padding: 15px ;padding-top: 21px">
        <ol class="breadcrumb">
    ...
    <div class="row mb-50">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
            <div class="detail-info">
                ...
                @else
                    <span class="float-end badge bg-danger">{{trans('website_index_trans.not_status')}}</span>
                @endif
                </h5>
                ...
                <div class="product-detail-rating">
                    ...
                    <div class="product-rate-cover text-end">
                        <div class="product-rate d-inline-block">
                            <h5>
                                @if($product->trend == 1)
                                    <span class="float-end badge bg-success">{{trans('website_index_trans.trending')}}</span>
                                @else
                                    <span class="float-end badge bg-danger">{{trans('website_index_trans.not_trending')}}</span>
                                @endif
                            </h5>
                ...
                <div class="detail-extralink">
                    ...
                    <div class="product-extra-link2">
                        <button  class="button button-add-to-cart" onclick="addToCart()">Add to cart</button>
                    </div>
                    <button class="btn">
                        <svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill: #ffffff
                                }</style><path d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z"/></svg>
                       </button>
                ...
                <div class="social-icons single-share">
                    <ul class="text-grey-5 d-inline-block">
                        ...
                        <li class="social-facebook"><a href="https://www.facebook.com/balaton2?mibextid=ZbWKwL"><img src="{{asset('assets/imgs/theme/icons/icon-facebook.svg')}}" alt=""></a></li>
                        <li class="social-instagram"><a href="https://instagram.com/bala.ton2020?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"><img src="{{asset('assets/imgs/theme/icons/icon-instagram.svg')}}" alt=""></a></li>
                    </ul>
                </div>
